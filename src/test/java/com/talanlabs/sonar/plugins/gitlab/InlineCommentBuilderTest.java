...
public class InlineCommentBuilderTest {
    ...
    public void testNoIssues() {
        Assertions.assertThat(new InlineCommentBuilder(config, "123", null, 1, Collections.emptyList(), new MarkDownUtils(), null).buildForMarkdown()).isEqualTo("");
    }
    ...
    public void testOneIssueAuthor() {
        ...
        Assertions.assertThat(new InlineCommentBuilder(config, "123", "john", 1, Collections.singletonList(r1), new MarkDownUtils(), null).buildForMarkdown())
    ...
    public void testTemplateConfig() {
        ...
        Assertions.assertThat(new InlineCommentBuilder(config, "123", null, 1, Collections.emptyList(), new MarkDownUtils(), null).buildForMarkdown())
                .isEqualTo("123\n" + "123456789\n" + "master\n" + "https://gitlab.com\n" + "10\n" + "0\n" + "0\n" + "-1\n" + "-1\n" + "-1\n" + "false\n" + "false\n" + "false\n" + "123\n" + "1");
    }
    ...
    public void testTemplateIssueFail() {
        ...
        Assertions.assertThatThrownBy(() -> new InlineCommentBuilder(config, "123", null, 1, Collections.emptyList(), new MarkDownUtils(), null).buildForMarkdown())
