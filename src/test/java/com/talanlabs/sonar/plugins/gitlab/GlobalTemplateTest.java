...
public class GlobalTemplateTest {
    ...
    public void testNoIssues() {
        Assertions.assertThat(new GlobalCommentBuilder(config, null, null, new Reporter(config), new MarkDownUtils(), null).buildForMarkdown()).isEqualTo("SonarQube analysis reported no issues.\n");
    }
    ...
    public void testOtherTemplate() {
        ...
        Assertions.assertThat(new GlobalCommentBuilder(config, null, null, reporter, new MarkDownUtils(), null).buildForMarkdown()).isEqualTo("SonarQube analysis reported 17 issues\n" +
    ...
    public void testQualityGateNoIssues() {
        Assertions.assertThat(new GlobalCommentBuilder(config, null, QualityGate.newBuilder().status(QualityGate.Status.OK).conditions(Collections.emptyList()).build(), new Reporter(config), new MarkDownUtils(), null).buildForMarkdown()).isEqualTo("SonarQube analysis indicates that quality gate is passed.\n" + "\n" + "SonarQube analysis reported no issues.\n");
    }
    ...
    public void testQualityGateOneIssue() {
        ...
        Assertions.assertThat(new GlobalCommentBuilder(config, null, QualityGate.newBuilder().status(QualityGate.Status.WARN).conditions(conditions).build(), reporter, new MarkDownUtils(), null).buildForMarkdown())
