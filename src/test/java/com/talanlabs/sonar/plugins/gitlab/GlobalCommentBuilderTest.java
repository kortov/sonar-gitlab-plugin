...
public class GlobalCommentBuilderTest {
    ...
    public void testNoIssues() {
        Assertions.assertThat(new GlobalCommentBuilder(config, null, null, null, new Reporter(config), new MarkDownUtils()).buildForMarkdown())
    ...
    public void testTemplateIssueFail() {
        ...
        Assertions.assertThatThrownBy(() -> new GlobalCommentBuilder(config, null, null, null, new Reporter(config), new MarkDownUtils()).buildForMarkdown())
    ...
    public void testQualityGateNoIssues() {
        Assertions.assertThat(
                new GlobalCommentBuilder(config, null, null, QualityGate.newBuilder().status(QualityGate.Status.OK).conditions(Collections.emptyList()).build(), new Reporter(config), new MarkDownUtils()).buildForMarkdown())
    ...
    public void testQualityGateOneIssue() {
        ...
        Assertions.assertThat(new GlobalCommentBuilder(config, null, null, QualityGate.newBuilder().status(QualityGate.Status.WARN).conditions(conditions).build(), reporter, new MarkDownUtils()).buildForMarkdown()).isEqualTo(
